    ...
    <div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px">
        <div class="mdk-drawer-layout__content page-content">
            ...
            <div class="navbar navbar-expand pr-0 navbar-light border-bottom-2" id="default-navbar" data-primary>
                ...
                <!-- Toggler -->
                <a href="compact-posts.html" class="navbar-toggler navbar-toggler-custom align-items-center justify-content-center d-none d-lg-flex" data-toggle="tooltip" data-title="Switch to Compact Layout" data-placement="bottom" data-boundary="window">
                ...
                <div class="posts-cards mb-24pt">
                    ...
                    <div class="card posts-card">
                        <div class="posts-card__content d-flex align-items-center flex-wrap">
                            ...
                            <div class="posts-card__title flex d-flex flex-column">
                                <a href="" class="card-title mr-3">Belajar Dasar Pemrograman Web</a>
                    ...
                    <div class="card posts-card">
                        <div class="posts-card__content d-flex align-items-center flex-wrap">
                            ...
                            <div class="posts-card__title flex d-flex flex-column">
                                <a href="" class="card-title mr-3">Tips Menulis Kode yang Konsisten di PHP</a>
                    ...
                    <div class="card posts-card">
                        <div class="posts-card__content d-flex align-items-center flex-wrap">
                            ...
                            <div class="posts-card__title flex d-flex flex-column">
                                <a href="" class="card-title mr-3">Cara menjadi Android Developer</a>
                                <small class="text-50">78 views last week</small>
                            </div>
                            <div class="d-flex align-items-center flex-column flex-sm-row posts-card__meta">
                                <div class="mr-3 text-50 text-uppercase posts-card__tag d-flex align-items-center">
                            ...
                            <div class="card posts-card-popular">
                                ...
                                <div class="posts-card-popular__content">
                                    ...
                                    <div class="posts-card-popular__title card-body">
                                        ...
                                        <h4 class="card-title m-0"><a href="">Merge Duplicates Inconsistent Symbols</a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card posts-card-popular">
                                ...
                                <div class="posts-card-popular__content">
                                    ...
                                    <div class="posts-card-popular__title card-body">
                                        ...
                                        <h4 class="card-title m-0"><a href="">Design Systems Essentials</a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card posts-card-popular">
                                ...
                                <div class="posts-card-popular__content">
                                    ...
                                    <div class="posts-card-popular__title card-body">
                                        ...
                                        <h4 class="card-title m-0"><a href="">Semantic Logo Design</a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <span class="sidebar-menu-text">Chips</span>
                        ...
                        <li class="sidebar-menu-item">
                            ...
                            <ul class="sidebar-submenu collapse sm-indent" id="layouts_menu">
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" href="mini-posts.html">
                                        <span class="sidebar-menu-text">Mini</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" href="mini-secondary-posts.html">
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" href="boxed-posts.html">
                                        <span class="sidebar-menu-text">Boxed</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" href="sticky-posts.html">
